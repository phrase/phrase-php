...
/**
 * JobKeysCreateParameters Class Doc Comment
 *
 * @category Class
 * @package  Phrase
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class JobKeysCreateParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'job_keys_create_parameters';
     ...
     *
     * @param string[]|null $translation_key_ids ids of keys that should added to the job
     *
     * @return $this
     */
