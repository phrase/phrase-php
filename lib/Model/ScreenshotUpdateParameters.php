...
/**
 * ScreenshotUpdateParameters Class Doc Comment
 *
 * @category Class
 * @package  Phrase
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ScreenshotUpdateParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'screenshot_update_parameters';
     ...
     * Sets name
     *
     * @param string|null $name Name of the screenshot
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string|null $description Description of the screenshot
     *
     * @return $this
     */
     ...
     * Sets filename
     *
     * @param \SplFileObject|null $filename Screenshot file
     *
     * @return $this
     */
