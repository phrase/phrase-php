...
/**
 * ScreenshotMarker Class Doc Comment
 *
 * @category Class
 * @package  Phrase
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ScreenshotMarker implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'screenshot_marker';
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'translation_key' => '\Phrase\Model\TranslationKey'
    ];
     ...
     *
     * @return \Phrase\Model\TranslationKey|null
     */
     ...
     *
     * @param \Phrase\Model\TranslationKey|null $translation_key translation_key
     *
     * @return $this
     */
