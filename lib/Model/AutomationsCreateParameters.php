...
/**
 * AutomationsCreateParameters Class Doc Comment
 *
 * @category Class
 * @package  Phrase
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AutomationsCreateParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'automations_create_parameters';
     ...
     * Sets status_filters
     *
     * @param string[] $status_filters Translation states used when selecting keys for a job.  States are derived from associated translations, not the keys themselves.  When review workflow is enabled, `ready_for_review` is internally treated as `translated`.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $include_only_updated_locales When `true`, the automation only acts on locales that changed since its last run. Defaults to `false`.
     *
     * @return $this
     */
