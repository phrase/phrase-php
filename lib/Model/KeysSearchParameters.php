...
/**
 * KeysSearchParameters Class Doc Comment
 *
 * @category Class
 * @package  Phrase
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class KeysSearchParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'keys_search_parameters';
     ...
     * Sets sort
     *
     * @param string|null $sort Sort by field. Can be one of: name, created_at, updated_at.
     *
     * @return $this
     */
