...
class BranchSyncParameters implements ModelInterface, ArrayAccess
{
     ...
     * Sets strategy
     *
     * @param string|null $strategy Conflict resolution strategy applied when the branch and its base have diverged. `use_main` keeps the values from the base branch; `use_branch` keeps the values from this branch.
     *
     * @return $this
     */
