...
/**
 * BitbucketSyncExportResponse Class Doc Comment
 *
 * @category Class
 * @package  Phrase
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class BitbucketSyncExportResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'bitbucket_sync_export_response';
    ...
    {
        $this->container['status_path'] = isset($data['status_path']) ? $data['status_path'] : null;
    }
    ...
    {
        return $this->container['status_path'];
    }

    /**
     * Sets status_path
     *
     * @param string|null $status_path status_path
     *
     * @return $this
     */
    public function setStatusPath($status_path)
    {
        $this->container['status_path'] = $status_path;
