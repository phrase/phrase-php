...
/**
 * OrganizationJobTemplateCreateParameters Class Doc Comment
 *
 * @category Class
 * @package  Phrase
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class OrganizationJobTemplateCreateParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'organization_job_template_create_parameters';
     ...
     * Sets owner_id
     *
     * @param string|null $owner_id Code of the account member to set as the job template owner. When omitted or blank, no owner is pre-set; the user who creates a job from this template is assigned as its owner at job-creation time.
     *
     * @return $this
     */
