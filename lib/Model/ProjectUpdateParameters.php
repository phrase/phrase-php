...
class ProjectUpdateParameters implements ModelInterface, ArrayAccess
{
     ...
     * Sets main_format
     *
     * @param string|null $main_format (Optional) Main file format specified by its API Extension name. Used for locale downloads if no format is specified. For API Extension names of available file formats see <a href=\"https://help.phrase.com/help/supported-platforms-and-formats\">Format Guide</a> or our <a href=\"#formats\">Formats API Endpoint</a>.
     *
     * @return $this
     */
