...
/**
 * SpaceUpdateParameters Class Doc Comment
 *
 * @category Class
 * @package  Phrase
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SpaceUpdateParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'space_update_parameters';
     ...
     * Sets name
     *
     * @param string|null $name New name of the space
     *
     * @return $this
     */
