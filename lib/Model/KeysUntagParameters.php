...
/**
 * KeysUntagParameters Class Doc Comment
 *
 * @category Class
 * @package  Phrase
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class KeysUntagParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'keys_untag_parameters';
     ...
     * Sets q
     *
     * @param string|null $q q_description_placeholder
     *
     * @return $this
     */
     ...
     * Sets tags
     *
     * @param string|null $tags Tag or comma-separated list of tags to remove from the matching collection of keys
     *
     * @return $this
     */
