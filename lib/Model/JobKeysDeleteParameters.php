...
/**
 * JobKeysDeleteParameters Class Doc Comment
 *
 * @category Class
 * @package  Phrase
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class JobKeysDeleteParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'job_keys_delete_parameters';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['translation_key_ids'] === null) {
            $invalidProperties[] = "'translation_key_ids' can't be null";
        }
     ...
     *
     * @param string[] $translation_key_ids ids of keys that should be deleted from the job
     *
     * @return $this
     */
