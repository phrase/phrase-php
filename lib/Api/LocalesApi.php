...
class LocalesApi
{
     ...
     * @param  string $branch specify the branch to use (optional)
     * @param  string $file_format File format name. See the [format guide](https://support.phrase.com/hc/en-us/sections/6111343326364) for all supported file formats. (optional)
     ...
     * @param  object $format_options Additional formatting and render options. See the [format guide](https://support.phrase.com/hc/en-us/sections/6111343326364) for a list of options available for each format. Specify format options like this: &#x60;...&amp;format_options[foo]&#x3D;bar&#x60; (optional)
     ...
     * @param  bool $skip_unverified_translations Indicates whether the locale file should skip all unverified translations. This parameter is deprecated and should be replaced with &#x60;include_unverified_translations&#x60;. (optional)
     ...
     * @param  string $source_locale_id Provides the source language of a corresponding job as the source language of the generated locale file. This parameter will be ignored unless used in combination with a &#x60;tag&#x60; parameter indicating a specific job. (optional)
     ...
     * @param  bool $filter_by_prefix Only download translation keys containing the prefix specified by &#x60;translation_key_prefix&#x60;, and remove that prefix from the generated file. Requires &#x60;translation_key_prefix&#x60; to be set. (optional)
     ...
     * @param  string $updated_since Only include translations and keys that have been updated since the given date. The date must be in ISO 8601 format (e.g., &#x60;2023-01-01T00:00:00Z&#x60;). (optional)
     *
     * @throws \Phrase\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SplFileObject
     */
    public function localeDownload($project_id, $id, $x_phrase_app_otp = null, $if_modified_since = null, $if_none_match = null, $branch = null, $file_format = null, $tags = null, $tag = null, $include_empty_translations = null, $exclude_empty_zero_forms = null, $include_translated_keys = null, $keep_notranslate_tags = null, $convert_emoji = null, $format_options = null, $encoding = null, $skip_unverified_translations = null, $include_unverified_translations = null, $use_last_reviewed_version = null, $fallback_locale_id = null, $use_locale_fallback = null, $fallback_for_unverified_translations = null, $source_locale_id = null, $translation_key_prefix = null, $filter_by_prefix = null, $custom_metadata_filters = null, $locale_ids = null, $updated_since = null)
    {
    ...
    protected function localeDownloadRequest($project_id, $id, $x_phrase_app_otp = null, $if_modified_since = null, $if_none_match = null, $branch = null, $file_format = null, $tags = null, $tag = null, $include_empty_translations = null, $exclude_empty_zero_forms = null, $include_translated_keys = null, $keep_notranslate_tags = null, $convert_emoji = null, $format_options = null, $encoding = null, $skip_unverified_translations = null, $include_unverified_translations = null, $use_last_reviewed_version = null, $fallback_locale_id = null, $use_locale_fallback = null, $fallback_for_unverified_translations = null, $source_locale_id = null, $translation_key_prefix = null, $filter_by_prefix = null, $custom_metadata_filters = null, $locale_ids = null, $updated_since = null)
    {
        ...
        // query params
        if ($use_locale_fallback !== null) {
            if('form' === 'form' && is_array($use_locale_fallback)) {
                foreach($use_locale_fallback as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['use_locale_fallback'] = $use_locale_fallback;
            }
        }
        // query params
        if ($fallback_for_unverified_translations !== null) {
            if('form' === 'form' && is_array($fallback_for_unverified_translations)) {
                foreach($fallback_for_unverified_translations as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['fallback_for_unverified_translations'] = $fallback_for_unverified_translations;
            }
        }
        // query params
        ...
        // query params
        if ($custom_metadata_filters !== null) {
            if('form' === 'deepObject' && is_array($custom_metadata_filters)) {
                foreach($custom_metadata_filters as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
