...
/**
 * ScreenshotMarkersApi Class Doc Comment
 *
 * @category Class
 * @package  Phrase
 * @author   OpenAPI Generator team
...
class ScreenshotMarkersApi
{
    ...
    /**
     * Operation screenshotMarkerCreate
     *
     * Create a screenshot marker
     *
     * @param  string $project_id Project ID (required)
     * @param  string $screenshot_id Screenshot ID (required)
     * @param  \Phrase\Model\ScreenshotMarkerCreateParameters $screenshot_marker_create_parameters screenshot_marker_create_parameters (required)
    ...
    {
        $this->screenshotMarkerCreateWithHttpInfo($project_id, $screenshot_id, $screenshot_marker_create_parameters, $x_phrase_app_otp);
    }

    /**
     * Operation screenshotMarkerCreateWithHttpInfo
     *
     * Create a screenshot marker
     *
     * @param  string $project_id Project ID (required)
     * @param  string $screenshot_id Screenshot ID (required)
     * @param  \Phrase\Model\ScreenshotMarkerCreateParameters $screenshot_marker_create_parameters (required)
     * @param  string $x_phrase_app_otp Two-Factor-Authentication token (optional) (optional)
     *
     * @throws \Phrase\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        $request = $this->screenshotMarkerCreateRequest($project_id, $screenshot_id, $screenshot_marker_create_parameters, $x_phrase_app_otp);
    ...
    /**
     * Operation screenshotMarkerCreateAsync
     *
     * Create a screenshot marker
     *
     * @param  string $project_id Project ID (required)
     ...
     */
    public function screenshotMarkerCreateAsync($project_id, $screenshot_id, $screenshot_marker_create_parameters, $x_phrase_app_otp = null)
    {
        return $this->screenshotMarkerCreateAsyncWithHttpInfo($project_id, $screenshot_id, $screenshot_marker_create_parameters, $x_phrase_app_otp)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation screenshotMarkerCreateAsyncWithHttpInfo
     *
     * Create a screenshot marker
     *
     * @param  string $project_id Project ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function screenshotMarkerCreateAsyncWithHttpInfo($project_id, $screenshot_id, $screenshot_marker_create_parameters, $x_phrase_app_otp = null)
    {
        $returnType = '';
        $request = $this->screenshotMarkerCreateRequest($project_id, $screenshot_id, $screenshot_marker_create_parameters, $x_phrase_app_otp);
    ...
    /**
     * Create request for operation 'screenshotMarkerCreate'
     *
     * @param  string $project_id Project ID (required)
     * @param  string $screenshot_id Screenshot ID (required)
     * @param  \Phrase\Model\ScreenshotMarkerCreateParameters $screenshot_marker_create_parameters (required)
     ...
     */
    protected function screenshotMarkerCreateRequest($project_id, $screenshot_id, $screenshot_marker_create_parameters, $x_phrase_app_otp = null)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_id when calling screenshotMarkerCreate'
            );
        }
        // verify the required parameter 'screenshot_id' is set
        if ($screenshot_id === null || (is_array($screenshot_id) && count($screenshot_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $screenshot_id when calling screenshotMarkerCreate'
            );
        }
        // verify the required parameter 'screenshot_marker_create_parameters' is set
        if ($screenshot_marker_create_parameters === null || (is_array($screenshot_marker_create_parameters) && count($screenshot_marker_create_parameters) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $screenshot_marker_create_parameters when calling screenshotMarkerCreate'
            );
        }

        $resourcePath = '/projects/{project_id}/screenshots/{screenshot_id}/markers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($screenshot_marker_create_parameters)) {
            $_tempBody = $screenshot_marker_create_parameters;
        }
    ...
    /**
     * Operation screenshotMarkerDelete
     *
    ...
    /**
     * Operation screenshotMarkerDeleteWithHttpInfo
     *
     * Delete a screenshot marker
     *
     * @param  string $project_id Project ID (required)
    ...
    /**
     * Operation screenshotMarkerDeleteAsync
     *
     * Delete a screenshot marker
     *
     * @param  string $project_id Project ID (required)
    ...
    /**
     * Operation screenshotMarkerDeleteAsyncWithHttpInfo
     *
     * Delete a screenshot marker
     *
     * @param  string $project_id Project ID (required)
    ...
    /**
     * Create request for operation 'screenshotMarkerDelete'
     *
     * @param  string $project_id Project ID (required)
     * @param  string $screenshot_id Screenshot ID (required)
     * @param  string $x_phrase_app_otp Two-Factor-Authentication token (optional) (optional)
    ...
    protected function screenshotMarkerDeleteRequest($project_id, $screenshot_id, $x_phrase_app_otp = null)
    {
        ...
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_id when calling screenshotMarkerDelete'
            );
        }
        // verify the required parameter 'screenshot_id' is set
        if ($screenshot_id === null || (is_array($screenshot_id) && count($screenshot_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $screenshot_id when calling screenshotMarkerDelete'
            );
        }
    ...
    /**
     * Operation screenshotMarkerShow
     *
    ...
    /**
     * Operation screenshotMarkerShowWithHttpInfo
     *
     * Get a single screenshot marker
     *
     * @param  string $project_id Project ID (required)
    ...
    public function screenshotMarkerShowWithHttpInfo($project_id, $screenshot_id, $id, $x_phrase_app_otp = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phrase\Model\ScreenshotMarker' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Phrase\Model\ScreenshotMarker', []),
    ...
    /**
     * Operation screenshotMarkerShowAsync
     *
     * Get a single screenshot marker
     *
     * @param  string $project_id Project ID (required)
    ...
    /**
     * Operation screenshotMarkerShowAsyncWithHttpInfo
     *
     * Get a single screenshot marker
     *
     * @param  string $project_id Project ID (required)
    ...
    /**
     * Create request for operation 'screenshotMarkerShow'
     *
     * @param  string $project_id Project ID (required)
     * @param  string $screenshot_id Screenshot ID (required)
     * @param  string $id ID (required)
    ...
    protected function screenshotMarkerShowRequest($project_id, $screenshot_id, $id, $x_phrase_app_otp = null)
    {
        ...
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_id when calling screenshotMarkerShow'
            );
        }
        // verify the required parameter 'screenshot_id' is set
        if ($screenshot_id === null || (is_array($screenshot_id) && count($screenshot_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $screenshot_id when calling screenshotMarkerShow'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling screenshotMarkerShow'
            );
        }

        $resourcePath = '/projects/{project_id}/screenshots/{screenshot_id}/markers/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation screenshotMarkerUpdate
     *
     * Update a screenshot marker
     *
     * @param  string $project_id Project ID (required)
     * @param  string $screenshot_id Screenshot ID (required)
     * @param  \Phrase\Model\ScreenshotMarkerUpdateParameters $screenshot_marker_update_parameters screenshot_marker_update_parameters (required)
     * @param  string $x_phrase_app_otp Two-Factor-Authentication token (optional) (optional)
     *
     * @throws \Phrase\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->screenshotMarkerUpdateWithHttpInfo($project_id, $screenshot_id, $screenshot_marker_update_parameters, $x_phrase_app_otp);
        return $response;
    }

    /**
     * Operation screenshotMarkerUpdateWithHttpInfo
     *
     * Update a screenshot marker
     *
     * @param  string $project_id Project ID (required)
     * @param  string $screenshot_id Screenshot ID (required)
     * @param  \Phrase\Model\ScreenshotMarkerUpdateParameters $screenshot_marker_update_parameters (required)
     * @param  string $x_phrase_app_otp Two-Factor-Authentication token (optional) (optional)
     *
     * @throws \Phrase\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        $request = $this->screenshotMarkerUpdateRequest($project_id, $screenshot_id, $screenshot_marker_update_parameters, $x_phrase_app_otp);
    ...
    /**
     * Operation screenshotMarkerUpdateAsync
     *
     * Update a screenshot marker
     *
     * @param  string $project_id Project ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function screenshotMarkerUpdateAsync($project_id, $screenshot_id, $screenshot_marker_update_parameters, $x_phrase_app_otp = null)
    {
        return $this->screenshotMarkerUpdateAsyncWithHttpInfo($project_id, $screenshot_id, $screenshot_marker_update_parameters, $x_phrase_app_otp)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation screenshotMarkerUpdateAsyncWithHttpInfo
     *
     * Update a screenshot marker
     *
     * @param  string $project_id Project ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function screenshotMarkerUpdateAsyncWithHttpInfo($project_id, $screenshot_id, $screenshot_marker_update_parameters, $x_phrase_app_otp = null)
    {
        $returnType = '\Phrase\Model\ScreenshotMarker';
        $request = $this->screenshotMarkerUpdateRequest($project_id, $screenshot_id, $screenshot_marker_update_parameters, $x_phrase_app_otp);
    ...
    /**
     * Create request for operation 'screenshotMarkerUpdate'
     *
     * @param  string $project_id Project ID (required)
     * @param  string $screenshot_id Screenshot ID (required)
     * @param  \Phrase\Model\ScreenshotMarkerUpdateParameters $screenshot_marker_update_parameters (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function screenshotMarkerUpdateRequest($project_id, $screenshot_id, $screenshot_marker_update_parameters, $x_phrase_app_otp = null)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_id when calling screenshotMarkerUpdate'
            );
        }
        // verify the required parameter 'screenshot_id' is set
        if ($screenshot_id === null || (is_array($screenshot_id) && count($screenshot_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $screenshot_id when calling screenshotMarkerUpdate'
            );
        }
        // verify the required parameter 'screenshot_marker_update_parameters' is set
        if ($screenshot_marker_update_parameters === null || (is_array($screenshot_marker_update_parameters) && count($screenshot_marker_update_parameters) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $screenshot_marker_update_parameters when calling screenshotMarkerUpdate'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($screenshot_marker_update_parameters)) {
            $_tempBody = $screenshot_marker_update_parameters;
        }
    ...
    /**
     * Operation screenshotMarkersList
     *
    ...
    /**
     * Operation screenshotMarkersListWithHttpInfo
     *
     * List screenshot markers
     *
     * @param  string $project_id Project ID (required)
    ...
    /**
     * Operation screenshotMarkersListAsync
     *
     * List screenshot markers
     *
     * @param  string $project_id Project ID (required)
    ...
    /**
     * Operation screenshotMarkersListAsyncWithHttpInfo
     *
     * List screenshot markers
     *
     * @param  string $project_id Project ID (required)
    ...
    /**
     * Create request for operation 'screenshotMarkersList'
     *
     * @param  string $project_id Project ID (required)
     * @param  string $id ID (required)
     * @param  string $x_phrase_app_otp Two-Factor-Authentication token (optional) (optional)
    ...
    protected function screenshotMarkersListRequest($project_id, $id, $x_phrase_app_otp = null, $page = null, $per_page = null)
    {
        ...
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_id when calling screenshotMarkersList'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling screenshotMarkersList'
            );
        }

        $resourcePath = '/projects/{project_id}/screenshots/{id}/markers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
