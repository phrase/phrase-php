...
/**
 * VersionsHistoryApi Class Doc Comment
 *
 * @category Class
 * @package  Phrase
 * @author   OpenAPI Generator team
...
class VersionsHistoryApi
{
     ...
     */
    public function versionShow($project_id, $translation_id, $id, $x_phrase_app_otp = null, $branch = null)
    {
        list($response) = $this->versionShowWithHttpInfo($project_id, $translation_id, $id, $x_phrase_app_otp, $branch);
        return $response;
    }

    /**
     * Operation versionShowWithHttpInfo
     *
     * Get a single version
     *
     * @param  string $project_id Project ID (required)
     ...
     */
    public function versionShowWithHttpInfo($project_id, $translation_id, $id, $x_phrase_app_otp = null, $branch = null)
    {
        $request = $this->versionShowRequest($project_id, $translation_id, $id, $x_phrase_app_otp, $branch);
     ...
     */
    public function versionShowAsync($project_id, $translation_id, $id, $x_phrase_app_otp = null, $branch = null)
    {
        return $this->versionShowAsyncWithHttpInfo($project_id, $translation_id, $id, $x_phrase_app_otp, $branch)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation versionShowAsyncWithHttpInfo
     *
     * Get a single version
     *
     * @param  string $project_id Project ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function versionShowAsyncWithHttpInfo($project_id, $translation_id, $id, $x_phrase_app_otp = null, $branch = null)
    {
        $returnType = '\Phrase\Model\TranslationVersionWithUser';
        $request = $this->versionShowRequest($project_id, $translation_id, $id, $x_phrase_app_otp, $branch);
    ...
    /**
     * Create request for operation 'versionShow'
     *
     * @param  string $project_id Project ID (required)
     * @param  string $translation_id Translation ID (required)
     * @param  string $id ID (required)
     ...
     */
    protected function versionShowRequest($project_id, $translation_id, $id, $x_phrase_app_otp = null, $branch = null)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_id when calling versionShow'
            );
        }
        // verify the required parameter 'translation_id' is set
        if ($translation_id === null || (is_array($translation_id) && count($translation_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $translation_id when calling versionShow'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling versionShow'
            );
        }

        $resourcePath = '/projects/{project_id}/translations/{translation_id}/versions/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation versionsListWithHttpInfo
     *
     * List all versions
     *
     * @param  string $project_id Project ID (required)
    ...
    /**
     * Operation versionsListAsyncWithHttpInfo
     *
     * List all versions
     *
     * @param  string $project_id Project ID (required)
    ...
    /**
     * Create request for operation 'versionsList'
     *
     * @param  string $project_id Project ID (required)
     * @param  string $translation_id Translation ID (required)
     * @param  string $x_phrase_app_otp Two-Factor-Authentication token (optional) (optional)
    ...
    protected function versionsListRequest($project_id, $translation_id, $x_phrase_app_otp = null, $page = null, $per_page = null, $branch = null)
    {
        ...
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_id when calling versionsList'
            );
        }
        // verify the required parameter 'translation_id' is set
        if ($translation_id === null || (is_array($translation_id) && count($translation_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $translation_id when calling versionsList'
            );
        }

        $resourcePath = '/projects/{project_id}/translations/{translation_id}/versions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
