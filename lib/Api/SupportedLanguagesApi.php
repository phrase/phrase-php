...
class SupportedLanguagesApi
{
    ...
    {
        list($response) = $this->languagesListWithHttpInfo();
        return $response;
    }

    /**
     * Operation languagesListWithHttpInfo
     *
     * List supported languages
     *
     *
     ...
     */
    public function languagesListWithHttpInfo()
    {
        $request = $this->languagesListRequest();
     ...
     */
    public function languagesListAsync()
    {
        return $this->languagesListAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation languagesListAsyncWithHttpInfo
     *
     * List supported languages
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function languagesListAsyncWithHttpInfo()
    {
        $returnType = 'array&lt;string,string&gt;';
        $request = $this->languagesListRequest();
    ...
    /**
     * Create request for operation 'languagesList'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function languagesListRequest()
    {
