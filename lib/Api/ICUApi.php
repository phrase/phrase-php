...
class ICUApi
{
    ...
    {
        list($response) = $this->icuSkeletonWithHttpInfo($icu_skeleton_parameters, $x_phrase_app_otp);
        return $response;
    }
    ...
    {
        $request = $this->icuSkeletonRequest($icu_skeleton_parameters, $x_phrase_app_otp);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phrase\Model\Icu' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Phrase\Model\Icu', []),
     ...
     */
    public function icuSkeletonAsync($icu_skeleton_parameters, $x_phrase_app_otp = null)
    {
        return $this->icuSkeletonAsyncWithHttpInfo($icu_skeleton_parameters, $x_phrase_app_otp)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function icuSkeletonAsyncWithHttpInfo($icu_skeleton_parameters, $x_phrase_app_otp = null)
    {
        $returnType = '\Phrase\Model\Icu';
        $request = $this->icuSkeletonRequest($icu_skeleton_parameters, $x_phrase_app_otp);
    ...
    /**
     * Create request for operation 'icuSkeleton'
     *
     * @param  \Phrase\Model\IcuSkeletonParameters $icu_skeleton_parameters (required)
     * @param  string $x_phrase_app_otp Two-Factor-Authentication token (optional) (optional)
     *
     ...
     */
    protected function icuSkeletonRequest($icu_skeleton_parameters, $x_phrase_app_otp = null)
    {
        // verify the required parameter 'icu_skeleton_parameters' is set
        if ($icu_skeleton_parameters === null || (is_array($icu_skeleton_parameters) && count($icu_skeleton_parameters) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $icu_skeleton_parameters when calling icuSkeleton'
            );
        }

        $resourcePath = '/icu/skeleton';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($icu_skeleton_parameters)) {
            $_tempBody = $icu_skeleton_parameters;
        }
