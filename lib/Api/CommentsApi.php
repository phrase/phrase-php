...
class CommentsApi
{
     ...
     * @return \Phrase\Model\Comment[]
     */
    public function commentsList($project_id, $key_id, $x_phrase_app_otp = null, $page = null, $per_page = null, $branch = null, $query = null, $locale_ids = null, $filters = null, $order = null)
    {
        list($response) = $this->commentsListWithHttpInfo($project_id, $key_id, $x_phrase_app_otp, $page, $per_page, $branch, $query, $locale_ids, $filters, $order);
        return $response;
    }
     ...
     * @return array of \Phrase\Model\Comment[], HTTP status code, HTTP response headers (array of strings)
     */
    public function commentsListWithHttpInfo($project_id, $key_id, $x_phrase_app_otp = null, $page = null, $per_page = null, $branch = null, $query = null, $locale_ids = null, $filters = null, $order = null)
    {
        $request = $this->commentsListRequest($project_id, $key_id, $x_phrase_app_otp, $page, $per_page, $branch, $query, $locale_ids, $filters, $order);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function commentsListAsync($project_id, $key_id, $x_phrase_app_otp = null, $page = null, $per_page = null, $branch = null, $query = null, $locale_ids = null, $filters = null, $order = null)
    {
        return $this->commentsListAsyncWithHttpInfo($project_id, $key_id, $x_phrase_app_otp, $page, $per_page, $branch, $query, $locale_ids, $filters, $order)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function commentsListAsyncWithHttpInfo($project_id, $key_id, $x_phrase_app_otp = null, $page = null, $per_page = null, $branch = null, $query = null, $locale_ids = null, $filters = null, $order = null)
    {
        $returnType = '\Phrase\Model\Comment[]';
        $request = $this->commentsListRequest($project_id, $key_id, $x_phrase_app_otp, $page, $per_page, $branch, $query, $locale_ids, $filters, $order);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function commentsListRequest($project_id, $key_id, $x_phrase_app_otp = null, $page = null, $per_page = null, $branch = null, $query = null, $locale_ids = null, $filters = null, $order = null)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
