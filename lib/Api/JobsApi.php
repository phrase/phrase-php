...
class JobsApi
{
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function jobLockAsync($project_id, $id, $x_phrase_app_otp = null, $branch = null)
    {
        return $this->jobLockAsyncWithHttpInfo($project_id, $id, $x_phrase_app_otp, $branch)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation jobLockAsyncWithHttpInfo
     *
     * Lock a job
     *
     * @param  string $project_id Project ID (required)
    ...
    /**
     * Create request for operation 'jobLock'
     *
     * @param  string $project_id Project ID (required)
     * @param  string $id ID (required)
     * @param  string $x_phrase_app_otp Two-Factor-Authentication token (optional) (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function jobLockRequest($project_id, $id, $x_phrase_app_otp = null, $branch = null)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_id when calling jobLock'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling jobLock'
            );
        }

        $resourcePath = '/projects/{project_id}/jobs/{id}/lock';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation jobUnlockWithHttpInfo
     *
     * Unlock a job
     *
     * @param  string $project_id Project ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function jobUnlockAsync($project_id, $id, $x_phrase_app_otp = null, $branch = null)
    {
        return $this->jobUnlockAsyncWithHttpInfo($project_id, $id, $x_phrase_app_otp, $branch)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation jobUnlockAsyncWithHttpInfo
     *
     * Unlock a job
     *
     * @param  string $project_id Project ID (required)
    ...
    /**
     * Create request for operation 'jobUnlock'
     *
     * @param  string $project_id Project ID (required)
     * @param  string $id ID (required)
     * @param  string $x_phrase_app_otp Two-Factor-Authentication token (optional) (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function jobUnlockRequest($project_id, $id, $x_phrase_app_otp = null, $branch = null)
    {
        // verify the required parameter 'project_id' is set
        if ($project_id === null || (is_array($project_id) && count($project_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $project_id when calling jobUnlock'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling jobUnlock'
            );
        }

        $resourcePath = '/projects/{project_id}/jobs/{id}/unlock';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
