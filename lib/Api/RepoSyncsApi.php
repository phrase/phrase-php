...
class RepoSyncsApi
{
    ...
    /**
     * Operation repoSyncCreate
     *
     * Create a Repo Sync
     *
     * @param  string $account_id Account ID (required)
     * @param  \Phrase\Model\RepoSyncCreateParameters $repo_sync_create_parameters repo_sync_create_parameters (required)
     * @param  string $x_phrase_app_otp Two-Factor-Authentication token (optional) (optional)
     *
     * @throws \Phrase\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->repoSyncCreateWithHttpInfo($account_id, $repo_sync_create_parameters, $x_phrase_app_otp);
        return $response;
    }

    /**
     * Operation repoSyncCreateWithHttpInfo
     *
     * Create a Repo Sync
     *
     * @param  string $account_id Account ID (required)
     * @param  \Phrase\Model\RepoSyncCreateParameters $repo_sync_create_parameters (required)
     * @param  string $x_phrase_app_otp Two-Factor-Authentication token (optional) (optional)
     *
     * @throws \Phrase\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        $request = $this->repoSyncCreateRequest($account_id, $repo_sync_create_parameters, $x_phrase_app_otp);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function repoSyncCreateAsync($account_id, $repo_sync_create_parameters, $x_phrase_app_otp = null)
    {
        return $this->repoSyncCreateAsyncWithHttpInfo($account_id, $repo_sync_create_parameters, $x_phrase_app_otp)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation repoSyncCreateAsyncWithHttpInfo
     *
     * Create a Repo Sync
     *
     * @param  string $account_id Account ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function repoSyncCreateAsyncWithHttpInfo($account_id, $repo_sync_create_parameters, $x_phrase_app_otp = null)
    {
        $returnType = '\Phrase\Model\RepoSync';
        $request = $this->repoSyncCreateRequest($account_id, $repo_sync_create_parameters, $x_phrase_app_otp);
    ...
    /**
     * Create request for operation 'repoSyncCreate'
     *
     * @param  string $account_id Account ID (required)
     * @param  \Phrase\Model\RepoSyncCreateParameters $repo_sync_create_parameters (required)
     * @param  string $x_phrase_app_otp Two-Factor-Authentication token (optional) (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function repoSyncCreateRequest($account_id, $repo_sync_create_parameters, $x_phrase_app_otp = null)
    {
        // verify the required parameter 'account_id' is set
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling repoSyncCreate'
            );
        }
        // verify the required parameter 'repo_sync_create_parameters' is set
        if ($repo_sync_create_parameters === null || (is_array($repo_sync_create_parameters) && count($repo_sync_create_parameters) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $repo_sync_create_parameters when calling repoSyncCreate'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($repo_sync_create_parameters)) {
            $_tempBody = $repo_sync_create_parameters;
        }
