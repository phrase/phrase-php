...
class RepoSyncsApi
{
    ...
    public function repoSyncExportWithHttpInfo($account_id, $id, $x_phrase_app_otp = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phrase\Model\RepoSyncExport' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Phrase\Model\RepoSyncExport', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function repoSyncImportWithHttpInfo($account_id, $id, $x_phrase_app_otp = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phrase\Model\RepoSyncImport' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Phrase\Model\RepoSyncImport', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
