...
class RepoSyncsApi
{
     ...
     */
    public function repoSyncEventShow($account_id, $repo_sync_id, $id, $x_phrase_app_otp = null)
    {
        list($response) = $this->repoSyncEventShowWithHttpInfo($account_id, $repo_sync_id, $id, $x_phrase_app_otp);
        return $response;
    }

    /**
     * Operation repoSyncEventShowWithHttpInfo
     *
     * Get a single Repo Sync Event
     *
     * @param  string $account_id Account ID (required)
     ...
     */
    public function repoSyncEventShowWithHttpInfo($account_id, $repo_sync_id, $id, $x_phrase_app_otp = null)
    {
        $request = $this->repoSyncEventShowRequest($account_id, $repo_sync_id, $id, $x_phrase_app_otp);
    ...
    /**
     * Operation repoSyncEventShowAsync
     *
     * Get a single Repo Sync Event
     *
     * @param  string $account_id Account ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function repoSyncEventShowAsync($account_id, $repo_sync_id, $id, $x_phrase_app_otp = null)
    {
        return $this->repoSyncEventShowAsyncWithHttpInfo($account_id, $repo_sync_id, $id, $x_phrase_app_otp)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation repoSyncEventShowAsyncWithHttpInfo
     *
     * Get a single Repo Sync Event
     *
     * @param  string $account_id Account ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function repoSyncEventShowAsyncWithHttpInfo($account_id, $repo_sync_id, $id, $x_phrase_app_otp = null)
    {
        $returnType = '\Phrase\Model\RepoSyncEvent';
        $request = $this->repoSyncEventShowRequest($account_id, $repo_sync_id, $id, $x_phrase_app_otp);
    ...
    /**
     * Create request for operation 'repoSyncEventShow'
     *
     * @param  string $account_id Account ID (required)
     * @param  string $repo_sync_id Repo Sync ID (required)
     * @param  string $id ID (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function repoSyncEventShowRequest($account_id, $repo_sync_id, $id, $x_phrase_app_otp = null)
    {
        // verify the required parameter 'account_id' is set
        if ($account_id === null || (is_array($account_id) && count($account_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_id when calling repoSyncEventShow'
            );
        }
        // verify the required parameter 'repo_sync_id' is set
        if ($repo_sync_id === null || (is_array($repo_sync_id) && count($repo_sync_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $repo_sync_id when calling repoSyncEventShow'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling repoSyncEventShow'
            );
        }

        $resourcePath = '/accounts/{account_id}/repo_syncs/{repo_sync_id}/events/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation repoSyncEventsWithHttpInfo
     *
     * Repository Syncs History
     *
     * @param  string $account_id Account ID (required)
    ...
    /**
     * Operation repoSyncEventsAsyncWithHttpInfo
     *
     * Repository Syncs History
     *
     * @param  string $account_id Account ID (required)
