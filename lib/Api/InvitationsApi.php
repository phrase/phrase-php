...
class InvitationsApi
{
     ...
     * @return \Phrase\Model\Invitation|\Phrase\Model\InvitationCreate422Response
     */
     ...
     * @throws \Phrase\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phrase\Model\Invitation|\Phrase\Model\InvitationCreate422Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function invitationCreateWithHttpInfo($account_id, $invitation_create_parameters, $x_phrase_app_otp = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 422:
                    if ('\Phrase\Model\InvitationCreate422Response' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Phrase\Model\InvitationCreate422Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
