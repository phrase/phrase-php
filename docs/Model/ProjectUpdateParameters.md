...
**tm_ids** | **string[]** | List of TMS translation memory IDs, used to provide reference translations for the AI translation agent. | [optional] 
**term_base_ids** | **string[]** | List of TMS term base IDs, used to ensure consistent terminology for the AI translation agent. | [optional] 
