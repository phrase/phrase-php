...
> commentCreate($project_id, $key_id, $comment_create_parameters, $x_phrase_app_otp)
...
try {
    $apiInstance->commentCreate($project_id, $key_id, $comment_create_parameters, $x_phrase_app_otp);
} catch (Exception $e) {
