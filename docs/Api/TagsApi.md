...
> \Phrase\Model\Tag[] tagsList($project_id, $x_phrase_app_otp, $page, $per_page, $exclude_system_tags, $only_system_tags, $branch, $q)
...
try {
    $result = $apiInstance->tagsList($project_id, $x_phrase_app_otp, $page, $per_page, $exclude_system_tags, $only_system_tags, $branch, $q);
    print_r($result);
} catch (Exception $e) {
