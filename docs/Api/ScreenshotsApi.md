...
> screenshotCreate($project_id, $screenshot_create_parameters, $x_phrase_app_otp)
...
try {
    $apiInstance->screenshotCreate($project_id, $screenshot_create_parameters, $x_phrase_app_otp);
} catch (Exception $e) {
